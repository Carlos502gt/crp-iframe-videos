window.addEventListener("message", function (e) {
	...
	var allorigins = "https://crp-proxy.herokuapp.com/get?url=";
	var video_id = video_config_media['metadata']['id'];
        var up_next_cooldown = e.data.up_next_cooldown;
        var up_next_enable = e.data.up_next_enable;
        var up_next = e.data.up_next;
        var version = e.data.version;
        var user_lang = e.data.lang;
        var series = e.data.series;
        var episode_traslate = "";
